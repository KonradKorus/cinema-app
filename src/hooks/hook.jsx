...
export const getScreenings = async () => {
  ...
  const response = await fetch(
    'http://localhost:8000/screenings?upcoming_events=false&page=1&size=50',
    {
      method: 'GET',
      headers: {
        'Content-type': 'application/json',
...
export const getReservedBookSeats = async (id) => {
  ...
  const response = await fetch(
    `http://localhost:8000/screenings/${id}/booked-seats`,
    {
      method: 'GET',
      headers: {
        'Content-type': 'application/json',
...
export const getUserReservations = async (id) => {
  ...
  const res = await fetch(
    `http://localhost:8000/reservations?user_id=${id}&page=1&size=50`,
    {
      method: 'GET',
      headers: {
        'Content-type': 'application/json',
